...
import { changeActiveBoard, fetchBoards, fetchUser } from "./actions";
import Loader from "./components/Loader";

const MIN_DELAY_CHUNK = 3000;
const loadable = (func, options = {}) =>
  baseLoadble(func, { ssr: true, fallback: <Loader /> });
          ...
          },
          {
            ...
            routes: [
              ...
              },
              {
                ...
                component: WorkBoard,
                secureRoute: true,
                loadData: (store, route, path, qParams, urlParams) => [
                  store.dispatch(changeActiveBoard(route.params.workspaceId)),
                ],
                routes: [
                  {
                    path:
                      "/workspace/:workspaceId/list/:listId/ticket/:ticketId",
                    component: TaskModal,
                    secureRoute: true,
                  },
                ],
